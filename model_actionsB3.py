...
La fonction pour calculer la valeur de SNR en indiquant les choix des modeles, n_bits et 
algo de compression
...
def model_snr(x, state, modele, nx_bit, algo_com, num_phase=0):
